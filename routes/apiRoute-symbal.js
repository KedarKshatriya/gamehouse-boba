...
const bobaDevnetRpcUrl = 'https://rinkeby.boba.network/';
var bobaHttpProvider = new ethers.providers.JsonRpcProvider(bobaDevnetRpcUrl);

const signer = wallet.connect(provider);
const signer2 = wallet2.connect(bobaHttpProvider)
