...
const cntAddress = "0xf0DD1276fbe4DDfe7A3F1551e49F6E40877AE973";
let nftContract = new ethers.Contract(cntAddress, bobaContractAbi, provider.getSigner());
$(document).ready( function () {
  setTimeout( function () {
    if (metamaskConfig.isMetamaskConnected) {
       getScores(accountAddress[0])
      console.log('Boosters: ', stepTime, killCounter);
    } else {
       metamaskConfig.connectToAccount();
    }
  }, 3000)
});
